...
# parser+z80.
$(T)/opcode_test: opcode.cpp parser.cpp z80.cpp expr.cpp keywords.cpp $(T)/opcode_test.cpp opcode.h parser.h z80.h expr.h
	$(TCXX) opcode.cpp parser.cpp z80.cpp expr.cpp keywords.cpp $(T)/opcode_test.cpp -o $@
