...
TESTS = $(T)/z80_test $(T)/expr_test $(T)/pp_test $(T)/parser_test \
        $(T)/asm_test $(T)/beautify_test $(T)/sna_test
TCXX  = $(CXX) $(CXXFLAGS) -I.
...
$(T)/asm_test: asm.cpp sym.cpp parser.cpp z80.cpp expr.cpp keywords.cpp $(T)/asm_test.cpp asm.h sym.h keywords.h
	$(TCXX) asm.cpp sym.cpp parser.cpp z80.cpp expr.cpp keywords.cpp $(T)/asm_test.cpp -o $@
...
$(T)/beautify_test: beautify.cpp keywords.cpp z80.cpp asm.cpp parser.cpp expr.cpp pp.cpp $(T)/beautify_test.cpp beautify.h keywords.h
	$(TCXX) beautify.cpp keywords.cpp z80.cpp asm.cpp parser.cpp expr.cpp pp.cpp $(T)/beautify_test.cpp -o $@
