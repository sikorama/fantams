...
start:
        ld     de, 0xC000
        ld     bc, __port_ram_gfx0 | __val_gfx0
        call   read_one
        ld     bc, __port_ram_gfx1 | __val_gfx1
        call   read_one
        ld     bc, __port_ram_gfx2 | __val_gfx2
        call   read_one
        ld     bc, __port_ram_gfx3 | __val_gfx3
        call   read_one
        ld     bc, __port_ram_resident | __val_resident   ; on rend la fenetre
        out    (c), c
stop:   jr     stop
